                ...
                <svg className="absolute w-0 h-0" aria-hidden="true">
                    <defs>
                        ...
                        <filter id="diamondGlow" x="-150%" y="-150%" width="400%" height="400%">
                            ...
                            <feFlood floodColor="#FFF35C" floodOpacity="0.3" />
                        ...
                        <linearGradient id="diamondGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                            <stop offset="0%" stopColor="#FFFF8F" />
                            <stop offset="40%" stopColor="#FFF35C" />
                            <stop offset="60%" stopColor="#E6DA48" />
                            <stop offset="100%" stopColor="#CCC033" />
                        </linearGradient>
